...
namespace Anamnese.API.Migrations
{
    ...
    [Migration("20240422201330_ProfissionalAvailable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Anamnese.API.ORM.Entity.ProfissionalAvailableModel", b =>
                {
                    ...
                    b.Property<int>("ProfisisonalProfissionalId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProfisisonalProfissionalId");
            ...
            modelBuilder.Entity("Anamnese.API.ORM.Entity.ProfissionalAvailableModel", b =>
                {
                    b.HasOne("Anamnese.API.ORM.Entity.ProfissionalModel", "Profisisonal")
                        .WithMany()
                        .HasForeignKey("ProfisisonalProfissionalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Profisisonal");
                });
